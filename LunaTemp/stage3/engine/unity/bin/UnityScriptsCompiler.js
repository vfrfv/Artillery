...
if ( TRACE ) { TRACE( "ManagerCamers#TurnPlayerCamera", this ); }
    ...
    Bridge.define("OutlineScript", {
        ...
        statics: {
            ...
            ctors: {
                init: function () {
if ( TRACE ) { TRACE( "OutlineScript#init", this ); }

                    this.registeredMeshes = new (System.Collections.Generic.HashSet$1(UnityEngine.Mesh)).ctor();
                }
            }
        },
        fields: {
        ...
        props: {
            OutlineMode: {
                get: function () {
if ( TRACE ) { TRACE( "OutlineScript#OutlineMode#get", this ); }

                    return this.outlineMode;
                },
                set: function (value) {
if ( TRACE ) { TRACE( "OutlineScript#OutlineMode#set", this ); }
            ...
            OutlineColor: {
                get: function () {
if ( TRACE ) { TRACE( "OutlineScript#OutlineColor#get", this ); }

                    return this.outlineColor.$clone();
                },
                set: function (value) {
if ( TRACE ) { TRACE( "OutlineScript#OutlineColor#set", this ); }

                    this.outlineColor = value.$clone();
                    this.needsUpdate = true;
                }
            },
            OutlineWidth: {
                get: function () {
if ( TRACE ) { TRACE( "OutlineScript#OutlineWidth#get", this ); }

                    return this.outlineWidth;
                },
                set: function (value) {
if ( TRACE ) { TRACE( "OutlineScript#OutlineWidth#set", this ); }
...
if ( TRACE ) { TRACE( "OutlineScript#init", this ); }
                ...
                this.outlineColor = new pc.Color( 1, 1, 1, 1 );
                this.outlineWidth = 2.0;
                this.bakeKeys = new (System.Collections.Generic.List$1(UnityEngine.Mesh)).ctor();
                this.bakeValues = new (System.Collections.Generic.List$1(OutlineScript.ListVector3)).ctor();
            }
        },
        methods: {
            /*OutlineScript.Awake start.*/
            Awake: function () {
if ( TRACE ) { TRACE( "OutlineScript#Awake", this ); }
                ...
                this.outlineMaskMaterial = UnityEngine.Object.Instantiate(UnityEngine.Material, UnityEngine.Resources.Load(UnityEngine.Material, "Materials/OutlineMask"));
                this.outlineFillMaterial = UnityEngine.Object.Instantiate(UnityEngine.Material, UnityEngine.Resources.Load(UnityEngine.Material, "Materials/OutlineFill"));
            ...
            /*OutlineScript.Awake end.*/

            /*OutlineScript.OnEnable start.*/
            OnEnable: function () {
if ( TRACE ) { TRACE( "OutlineScript#OnEnable", this ); }

                var $t, $t1;
                $t = Bridge.getEnumerator(this.renderers);
                try {
                    while ($t.moveNext()) {
                        var renderer = $t.Current;

                        // Append outline shaders
                        var materials = ($t1 = UnityEngine.Material, System.Linq.Enumerable.from(renderer.sharedMaterials, $t1).toList($t1));
            ...
            /*OutlineScript.OnEnable end.*/

            /*OutlineScript.OnValidate start.*/
            OnValidate: function () {
if ( TRACE ) { TRACE( "OutlineScript#OnValidate", this ); }
            ...
            /*OutlineScript.OnValidate end.*/

            /*OutlineScript.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "OutlineScript#Update", this ); }
            ...
            /*OutlineScript.Update end.*/

            /*OutlineScript.OnDisable start.*/
            OnDisable: function () {
if ( TRACE ) { TRACE( "OutlineScript#OnDisable", this ); }
            ...
            /*OutlineScript.OnDisable end.*/

            /*OutlineScript.OnDestroy start.*/
            OnDestroy: function () {
if ( TRACE ) { TRACE( "OutlineScript#OnDestroy", this ); }


                // Destroy material instances
                UnityEngine.Object.Destroy(this.outlineMaskMaterial);
                UnityEngine.Object.Destroy(this.outlineFillMaterial);
            },
            /*OutlineScript.OnDestroy end.*/

            /*OutlineScript.Bake start.*/
            Bake: function () {
if ( TRACE ) { TRACE( "OutlineScript#Bake", this ); }

                var $t, $t1;

                // Generate smooth normals for each mesh
                var bakedMeshes = new (System.Collections.Generic.HashSet$1(UnityEngine.Mesh)).ctor();

                $t = Bridge.getEnumerator(this.GetComponentsInChildren(UnityEngine.MeshFilter));
                try {
                    while ($t.moveNext()) {
                        var meshFilter = $t.Current;
                        ...
                        this.bakeValues.add(($t1 = new OutlineScript.ListVector3(), $t1.data = smoothNormals, $t1));
                    }
                } finally {
                    if (Bridge.is($t, System.IDisposable)) {
                        $t.System$IDisposable$Dispose();
            ...
            /*OutlineScript.Bake end.*/

            /*OutlineScript.LoadSmoothNormals start.*/
            LoadSmoothNormals: function () {
if ( TRACE ) { TRACE( "OutlineScript#LoadSmoothNormals", this ); }
                ...
                try {
                    while ($t.moveNext()) {
                        ...
                        if (!OutlineScript.registeredMeshes.add(meshFilter.sharedMesh)) {
                            continue;
                        }

                        // Retrieve or generate smooth normals
                        var index = this.bakeKeys.indexOf(meshFilter.sharedMesh);
                        var smoothNormals = (index >= 0) ? this.bakeValues.getItem(index).data : this.SmoothNormals(meshFilter.sharedMesh);

                        // Store smooth normals in UV3
                        meshFilter.sharedMesh.SetUVs$1(3, smoothNormals);

                        // Combine submeshes
                        var renderer = meshFilter.GetComponent(UnityEngine.Renderer);
                ...
                $t1 = Bridge.getEnumerator(this.GetComponentsInChildren(UnityEngine.SkinnedMeshRenderer));
                try {
                    while ($t1.moveNext()) {
                        var skinnedMeshRenderer = $t1.Current;

                        // Skip if UV3 has already been reset
                        if (!OutlineScript.registeredMeshes.add(skinnedMeshRenderer.sharedMesh)) {
                            continue;
                        }

                        // Clear UV3
                        skinnedMeshRenderer.sharedMesh.uv4 = System.Array.init(skinnedMeshRenderer.sharedMesh.vertexCount, function (){
            ...
            /*OutlineScript.LoadSmoothNormals end.*/

            /*OutlineScript.SmoothNormals start.*/
            SmoothNormals: function (mesh) {
if ( TRACE ) { TRACE( "OutlineScript#SmoothNormals", this ); }

                var $t, $t1, $t2;

                // Group vertices by location
                var groups = System.Linq.Enumerable.from(mesh.vertices, UnityEngine.Vector3).select(function (vertex, index) {
                        return new (System.Collections.Generic.KeyValuePair$2(UnityEngine.Vector3,System.Int32)).$ctor1(vertex.$clone(), index);
                    }).groupBy(function (pair) {
                    return pair.key;
                });

                // Copy normals to a new list
                var smoothNormals = new (System.Collections.Generic.List$1(UnityEngine.Vector3)).$ctor1(mesh.normals);
                ...
                try {
                    while ($t.moveNext()) {
                        ...
                        var smoothNormal = pc.Vec3.ZERO.clone();

                        $t1 = Bridge.getEnumerator(group);
                        try {
                            while ($t1.moveNext()) {
                                var pair = $t1.Current;
                                smoothNormal = smoothNormal.$clone().add( smoothNormals.getItem(pair.value).$clone() );
                            }
                        } finally {
                            if (Bridge.is($t1, System.IDisposable)) {
                                $t1.System$IDisposable$Dispose();
                        ...
                        $t2 = Bridge.getEnumerator(group);
                        try {
                            while ($t2.moveNext()) {
                                var pair1 = $t2.Current;
                                smoothNormals.setItem(pair1.value, smoothNormal.$clone());
                            }
                        } finally {
            ...
            /*OutlineScript.SmoothNormals end.*/

            /*OutlineScript.CombineSubmeshes start.*/
            CombineSubmeshes: function (mesh, materials) {
if ( TRACE ) { TRACE( "OutlineScript#CombineSubmeshes", this ); }
                ...
                mesh.subMeshCount = (mesh.subMeshCount + 1) | 0;
                mesh.SetTriangles$2(mesh.triangles, ((mesh.subMeshCount - 1) | 0));
            },
            /*OutlineScript.CombineSubmeshes end.*/

            /*OutlineScript.UpdateMaterialProperties start.*/
            UpdateMaterialProperties: function () {
if ( TRACE ) { TRACE( "OutlineScript#UpdateMaterialProperties", this ); }


                // Apply properties according to mode
                this.outlineFillMaterial.SetColor$1("_OutlineColor", this.outlineColor);

                switch (this.outlineMode) {
                    case OutlineScript.Mode.OutlineAll: 
                        this.outlineMaskMaterial.SetFloat$1("_ZTest", UnityEngine.Rendering.CompareFunction.Always);
                        this.outlineFillMaterial.SetFloat$1("_ZTest", UnityEngine.Rendering.CompareFunction.Always);
                        this.outlineFillMaterial.SetFloat$1("_OutlineWidth", this.outlineWidth);
                        break;
                    case OutlineScript.Mode.OutlineVisible: 
                        this.outlineMaskMaterial.SetFloat$1("_ZTest", UnityEngine.Rendering.CompareFunction.Always);
                        this.outlineFillMaterial.SetFloat$1("_ZTest", UnityEngine.Rendering.CompareFunction.LessEqual);
                        this.outlineFillMaterial.SetFloat$1("_OutlineWidth", this.outlineWidth);
                        break;
                    case OutlineScript.Mode.OutlineHidden: 
                        this.outlineMaskMaterial.SetFloat$1("_ZTest", UnityEngine.Rendering.CompareFunction.Always);
                        this.outlineFillMaterial.SetFloat$1("_ZTest", UnityEngine.Rendering.CompareFunction.Greater);
                        this.outlineFillMaterial.SetFloat$1("_OutlineWidth", this.outlineWidth);
                        break;
                    case OutlineScript.Mode.OutlineAndSilhouette: 
                        this.outlineMaskMaterial.SetFloat$1("_ZTest", UnityEngine.Rendering.CompareFunction.LessEqual);
                        this.outlineFillMaterial.SetFloat$1("_ZTest", UnityEngine.Rendering.CompareFunction.Always);
                        this.outlineFillMaterial.SetFloat$1("_OutlineWidth", this.outlineWidth);
                        break;
                    case OutlineScript.Mode.SilhouetteOnly: 
                        this.outlineMaskMaterial.SetFloat$1("_ZTest", UnityEngine.Rendering.CompareFunction.LessEqual);
                        this.outlineFillMaterial.SetFloat$1("_ZTest", UnityEngine.Rendering.CompareFunction.Greater);
                        this.outlineFillMaterial.SetFloat$1("_OutlineWidth", 0.0);
                        break;
                }
            },
            /*OutlineScript.UpdateMaterialProperties end.*/
    ...
    /*OutlineScript+ListVector3 start.*/
    Bridge.define("OutlineScript.ListVector3", {
        $kind: 1002,
        fields: {
            data: null
        }
    });
    /*OutlineScript+ListVector3 end.*/

    /*OutlineScript+Mode start.*/
    Bridge.define("OutlineScript.Mode", {
        $kind: 1006,
        statics: {
            fields: {
                OutlineAll: 0,
...
if ( TRACE ) { TRACE( "VariableJoystick#HandleInput", this ); }
    ...
    var $m = Bridge.setMetadata,
        $n = ["System","System.Collections","UnityEngine","System.Collections.Generic","UnityEngine.UI","UnityEngine.EventSystems","Howitzer","DG.Tweening","UI","Fabric","Bootstraps","UnityEngine.Audio","DG.Tweening.Core","DG.Tweening.Plugins.Core.PathCore","System.Globalization","DG.Tweening.Plugins.Options"];

    /*Cross start.*/
    $m("Cross", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"a":1,"n":"ScaleAndDisable","t":8,"sn":"ScaleAndDisable","rt":$n[1].IEnumerator},{"a":1,"n":"ScaleOverTime","t":8,"pi":[{"n":"targetScale","pt":$n[2].Vector3,"ps":0},{"n":"duration","pt":$n[0].Single,"ps":1}],"sn":"ScaleOverTime","rt":$n[1].IEnumerator,"p":[$n[2].Vector3,$n[0].Single]}]}; }, $n);
    /*Cross end.*/

    /*ExclamationMark start.*/
    $m("ExclamationMark", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"LateUpdate","t":8,"sn":"LateUpdate","rt":$n[0].Void},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"a":1,"n":"SwitchOff","t":8,"sn":"SwitchOff","rt":$n[1].IEnumerator},{"a":1,"n":"_camera","t":4,"rt":$n[2].Camera,"sn":"_camera"},{"a":1,"n":"_degree","t":4,"rt":$n[0].Single,"sn":"_degree","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*ExclamationMark end.*/

    /*OutlineScript start.*/
    $m("OutlineScript", function () { return {"nested":[OutlineScript.Mode,OutlineScript.ListVector3],"att":1048577,"a":2,"at":[new UnityEngine.DisallowMultipleComponent()],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"Bake","t":8,"sn":"Bake","rt":$n[0].Void},{"a":1,"n":"CombineSubmeshes","t":8,"pi":[{"n":"mesh","pt":$n[2].Mesh,"ps":0},{"n":"materials","pt":System.Array.type(UnityEngine.Material),"ps":1}],"sn":"CombineSubmeshes","rt":$n[0].Void,"p":[$n[2].Mesh,System.Array.type(UnityEngine.Material)]},{"a":1,"n":"LoadSmoothNormals","t":8,"sn":"LoadSmoothNormals","rt":$n[0].Void},{"a":1,"n":"OnDestroy","t":8,"sn":"OnDestroy","rt":$n[0].Void},{"a":1,"n":"OnDisable","t":8,"sn":"OnDisable","rt":$n[0].Void},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"a":1,"n":"OnValidate","t":8,"sn":"OnValidate","rt":$n[0].Void},{"a":1,"n":"SmoothNormals","t":8,"pi":[{"n":"mesh","pt":$n[2].Mesh,"ps":0}],"sn":"SmoothNormals","rt":$n[3].List$1(UnityEngine.Vector3),"p":[$n[2].Mesh]},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"UpdateMaterialProperties","t":8,"sn":"UpdateMaterialProperties","rt":$n[0].Void},{"a":2,"n":"OutlineColor","t":16,"rt":$n[2].Color,"g":{"a":2,"n":"get_OutlineColor","t":8,"rt":$n[2].Color,"fg":"OutlineColor"},"s":{"a":2,"n":"set_OutlineColor","t":8,"p":[$n[2].Color],"rt":$n[0].Void,"fs":"OutlineColor"},"fn":"OutlineColor"},{"a":2,"n":"OutlineMode","t":16,"rt":OutlineScript.Mode,"g":{"a":2,"n":"get_OutlineMode","t":8,"rt":OutlineScript.Mode,"fg":"OutlineMode","box":function ($v) { return Bridge.box($v, OutlineScript.Mode, System.Enum.toStringFn(OutlineScript.Mode));}},"s":{"a":2,"n":"set_OutlineMode","t":8,"p":[OutlineScript.Mode],"rt":$n[0].Void,"fs":"OutlineMode"},"fn":"OutlineMode"},{"a":2,"n":"OutlineWidth","t":16,"rt":$n[0].Single,"g":{"a":2,"n":"get_OutlineWidth","t":8,"rt":$n[0].Single,"fg":"OutlineWidth","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},"s":{"a":2,"n":"set_OutlineWidth","t":8,"p":[$n[0].Single],"rt":$n[0].Void,"fs":"OutlineWidth"},"fn":"OutlineWidth"},{"at":[new UnityEngine.SerializeFieldAttribute(),new UnityEngine.HideInInspector()],"a":1,"n":"bakeKeys","t":4,"rt":$n[3].List$1(UnityEngine.Mesh),"sn":"bakeKeys"},{"at":[new UnityEngine.SerializeFieldAttribute(),new UnityEngine.HideInInspector()],"a":1,"n":"bakeValues","t":4,"rt":$n[3].List$1(OutlineScript.ListVector3),"sn":"bakeValues"},{"a":1,"n":"needsUpdate","t":4,"rt":$n[0].Boolean,"sn":"needsUpdate","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"outlineColor","t":4,"rt":$n[2].Color,"sn":"outlineColor"},{"a":1,"n":"outlineFillMaterial","t":4,"rt":$n[2].Material,"sn":"outlineFillMaterial"},{"a":1,"n":"outlineMaskMaterial","t":4,"rt":$n[2].Material,"sn":"outlineMaskMaterial"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"outlineMode","t":4,"rt":OutlineScript.Mode,"sn":"outlineMode","box":function ($v) { return Bridge.box($v, OutlineScript.Mode, System.Enum.toStringFn(OutlineScript.Mode));}},{"at":[new UnityEngine.SerializeFieldAttribute(),new UnityEngine.RangeAttribute(0.0, 10.0)],"a":1,"n":"outlineWidth","t":4,"rt":$n[0].Single,"sn":"outlineWidth","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.HeaderAttribute("Optional"),new UnityEngine.SerializeFieldAttribute(),new UnityEngine.TooltipAttribute("Precompute enabled: Per-vertex calculations are performed in the editor and serialized with the object. Precompute disabled: Per-vertex calculations are performed at runtime in Awake(). This may cause a pause for large meshes.")],"a":1,"n":"precomputeOutline","t":4,"rt":$n[0].Boolean,"sn":"precomputeOutline","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"registeredMeshes","is":true,"t":4,"rt":$n[3].HashSet$1(UnityEngine.Mesh),"sn":"registeredMeshes"},{"a":1,"n":"renderers","t":4,"rt":System.Array.type(UnityEngine.Renderer),"sn":"renderers"}]}; }, $n);
    /*OutlineScript end.*/

    /*OutlineScript+Mode start.*/
    $m("OutlineScript.Mode", function () { return {"td":OutlineScript,"att":258,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"OutlineAll","is":true,"t":4,"rt":OutlineScript.Mode,"sn":"OutlineAll","box":function ($v) { return Bridge.box($v, OutlineScript.Mode, System.Enum.toStringFn(OutlineScript.Mode));}},{"a":2,"n":"OutlineAndSilhouette","is":true,"t":4,"rt":OutlineScript.Mode,"sn":"OutlineAndSilhouette","box":function ($v) { return Bridge.box($v, OutlineScript.Mode, System.Enum.toStringFn(OutlineScript.Mode));}},{"a":2,"n":"OutlineHidden","is":true,"t":4,"rt":OutlineScript.Mode,"sn":"OutlineHidden","box":function ($v) { return Bridge.box($v, OutlineScript.Mode, System.Enum.toStringFn(OutlineScript.Mode));}},{"a":2,"n":"OutlineVisible","is":true,"t":4,"rt":OutlineScript.Mode,"sn":"OutlineVisible","box":function ($v) { return Bridge.box($v, OutlineScript.Mode, System.Enum.toStringFn(OutlineScript.Mode));}},{"a":2,"n":"SilhouetteOnly","is":true,"t":4,"rt":OutlineScript.Mode,"sn":"SilhouetteOnly","box":function ($v) { return Bridge.box($v, OutlineScript.Mode, System.Enum.toStringFn(OutlineScript.Mode));}}]}; }, $n);
    /*OutlineScript+Mode end.*/

    /*OutlineScript+ListVector3 start.*/
    $m("OutlineScript.ListVector3", function () { return {"td":OutlineScript,"att":1056771,"a":1,"at":[new System.SerializableAttribute()],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"data","t":4,"rt":$n[3].List$1(UnityEngine.Vector3),"sn":"data"}]}; }, $n);
    /*OutlineScript+ListVector3 end.*/
    ...
    /*CFX_SpawnSystem start.*/
    $m("CFX_SpawnSystem", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":2,"n":"GetNextObject","is":true,"t":8,"pi":[{"n":"sourceObj","pt":$n[2].GameObject,"ps":0},{"n":"activateObject","dv":true,"o":true,"pt":$n[0].Boolean,"ps":1}],"sn":"GetNextObject","rt":$n[2].GameObject,"p":[$n[2].GameObject,$n[0].Boolean]},{"a":2,"n":"PreloadObject","is":true,"t":8,"pi":[{"n":"sourceObj","pt":$n[2].GameObject,"ps":0},{"n":"poolSize","dv":1,"o":true,"pt":$n[0].Int32,"ps":1}],"sn":"PreloadObject","rt":$n[0].Void,"p":[$n[2].GameObject,$n[0].Int32]},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"UnloadObjects","is":true,"t":8,"pi":[{"n":"sourceObj","pt":$n[2].GameObject,"ps":0}],"sn":"UnloadObjects","rt":$n[0].Void,"p":[$n[2].GameObject]},{"a":1,"n":"addObjectToPool","t":8,"pi":[{"n":"sourceObject","pt":$n[2].GameObject,"ps":0},{"n":"number","pt":$n[0].Int32,"ps":1}],"sn":"addObjectToPool","rt":$n[0].Void,"p":[$n[2].GameObject,$n[0].Int32]},{"a":1,"n":"increasePoolCursor","t":8,"pi":[{"n":"uniqueId","pt":$n[0].Int32,"ps":0}],"sn":"increasePoolCursor","rt":$n[0].Void,"p":[$n[0].Int32]},{"a":1,"n":"removeObjectsFromPool","t":8,"pi":[{"n":"sourceObject","pt":$n[2].GameObject,"ps":0}],"sn":"removeObjectsFromPool","rt":$n[0].Void,"p":[$n[2].GameObject]},{"a":2,"n":"AllObjectsLoaded","is":true,"t":16,"rt":$n[0].Boolean,"g":{"a":2,"n":"get_AllObjectsLoaded","t":8,"rt":$n[0].Boolean,"fg":"AllObjectsLoaded","is":true,"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},"fn":"AllObjectsLoaded"},{"a":1,"n":"allObjectsLoaded","t":4,"rt":$n[0].Boolean,"sn":"allObjectsLoaded","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"hideObjectsInHierarchy","t":4,"rt":$n[0].Boolean,"sn":"hideObjectsInHierarchy","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"instance","is":true,"t":4,"rt":CFX_SpawnSystem,"sn":"instance"},{"a":2,"n":"instantiateIfNeeded","t":4,"rt":$n[0].Boolean,"sn":"instantiateIfNeeded","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"instantiatedObjects","t":4,"rt":$n[3].Dictionary$2(System.Int32,System.Collections.Generic.List$1(UnityEngine.GameObject)),"sn":"instantiatedObjects"},{"a":2,"n":"objectsToPreload","t":4,"rt":System.Array.type(UnityEngine.GameObject),"sn":"objectsToPreload"},{"a":2,"n":"objectsToPreloadTimes","t":4,"rt":$n[0].Array.type(System.Int32),"sn":"objectsToPreloadTimes"},{"a":2,"n":"onlyGetInactiveObjects","t":4,"rt":$n[0].Boolean,"sn":"onlyGetInactiveObjects","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"poolCursors","t":4,"rt":$n[3].Dictionary$2(System.Int32,System.Int32),"sn":"poolCursors"},{"a":2,"n":"spawnAsChildren","t":4,"rt":$n[0].Boolean,"sn":"spawnAsChildren","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}}]}; }, $n);
    /*CFX_SpawnSystem end.*/
    ...
    /*Howitzer.ObjectPoolShooting start.*/
    $m("Howitzer.ObjectPoolShooting", function () { return {"att":1048577,"a":2,"m":[{"a":2,"n":".ctor","t":1,"p":[$n[2].GameObject,$n[2].Vector3,$n[2].Quaternion,$n[0].Int32],"pi":[{"n":"prefab","pt":$n[2].GameObject,"ps":0},{"n":"position","pt":$n[2].Vector3,"ps":1},{"n":"rotation","pt":$n[2].Quaternion,"ps":2},{"n":"initialSize","pt":$n[0].Int32,"ps":3}],"sn":"ctor"},{"a":2,"n":"GetObject","t":8,"sn":"GetObject","rt":$n[2].GameObject},{"a":2,"n":"ReturnObject","t":8,"pi":[{"n":"obj","pt":$n[2].GameObject,"ps":0}],"sn":"ReturnObject","rt":$n[0].Void,"p":[$n[2].GameObject]},{"a":1,"n":"pool","t":4,"rt":$n[3].Queue$1(UnityEngine.GameObject),"sn":"pool"},{"a":1,"n":"prefab","t":4,"rt":$n[2].GameObject,"sn":"prefab"}]}; }, $n);
    /*Howitzer.ObjectPoolShooting end.*/
    ...
    /*BehaviourAI.TankAI start.*/
    $m("BehaviourAI.TankAI", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"ChooseNextTarget","t":8,"sn":"ChooseNextTarget","rt":$n[0].Void},{"a":2,"n":"DisableTank","t":8,"sn":"DisableTank","rt":$n[0].Void},{"a":1,"n":"IsTankFacingTarget","t":8,"sn":"IsTankFacingTarget","rt":$n[0].Boolean,"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"MoveTowardsTarget","t":8,"sn":"MoveTowardsTarget","rt":$n[0].Void},{"a":1,"n":"RotateTank","t":8,"sn":"RotateTank","rt":$n[0].Void},{"a":2,"n":"SetTargets","t":8,"pi":[{"n":"newTargets","pt":System.Array.type(UnityEngine.Transform),"ps":0}],"sn":"SetTargets","rt":$n[0].Void,"p":[System.Array.type(UnityEngine.Transform)]},{"a":2,"n":"ShowSign","t":8,"sn":"ShowSign","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":2,"n":"IsAlive","t":16,"rt":$n[0].Boolean,"g":{"a":2,"n":"get_IsAlive","t":8,"rt":$n[0].Boolean,"fg":"IsAlive","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},"fn":"IsAlive"},{"a":1,"n":"_currentTarget","t":4,"rt":$n[2].Transform,"sn":"_currentTarget"},{"a":1,"n":"_currentTargetIndex","t":4,"rt":$n[0].Int32,"sn":"_currentTargetIndex","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_exclamationMark","t":4,"rt":ExclamationMark,"sn":"_exclamationMark"},{"a":1,"n":"_isDisabled","t":4,"rt":$n[0].Boolean,"sn":"_isDisabled","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"_isWaiting","t":4,"rt":$n[0].Boolean,"sn":"_isWaiting","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"_targets","t":4,"rt":System.Array.type(UnityEngine.Transform),"sn":"_targets"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"moveSpeed","t":4,"rt":$n[0].Single,"sn":"moveSpeed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"rotationSpeed","t":4,"rt":$n[0].Single,"sn":"rotationSpeed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"stopDistance","t":4,"rt":$n[0].Single,"sn":"stopDistance","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*BehaviourAI.TankAI end.*/

    /*DG.Tweening.DOTweenModuleAudio start.*/
    $m("DG.Tweening.DOTweenModuleAudio", function () { return {"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOComplete","is":true,"t":8,"pi":[{"n":"target","pt":$n[11].AudioMixer,"ps":0},{"n":"withCallbacks","dv":false,"o":true,"pt":$n[0].Boolean,"ps":1}],"sn":"DOComplete","rt":$n[0].Int32,"p":[$n[11].AudioMixer,$n[0].Boolean],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].AudioSource,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade","rt":$n[12].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[2].AudioSource,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFlip","is":true,"t":8,"pi":[{"n":"target","pt":$n[11].AudioMixer,"ps":0}],"sn":"DOFlip","rt":$n[0].Int32,"p":[$n[11].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOGoto","is":true,"t":8,"pi":[{"n":"target","pt":$n[11].AudioMixer,"ps":0},{"n":"to","pt":$n[0].Single,"ps":1},{"n":"andPlay","dv":false,"o":true,"pt":$n[0].Boolean,"ps":2}],"sn":"DOGoto","rt":$n[0].Int32,"p":[$n[11].AudioMixer,$n[0].Single,$n[0].Boolean],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOKill","is":true,"t":8,"pi":[{"n":"target","pt":$n[11].AudioMixer,"ps":0},{"n":"complete","dv":false,"o":true,"pt":$n[0].Boolean,"ps":1}],"sn":"DOKill","rt":$n[0].Int32,"p":[$n[11].AudioMixer,$n[0].Boolean],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOPause","is":true,"t":8,"pi":[{"n":"target","pt":$n[11].AudioMixer,"ps":0}],"sn":"DOPause","rt":$n[0].Int32,"p":[$n[11].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOPitch","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].AudioSource,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOPitch","rt":$n[12].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[2].AudioSource,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOPlay","is":true,"t":8,"pi":[{"n":"target","pt":$n[11].AudioMixer,"ps":0}],"sn":"DOPlay","rt":$n[0].Int32,"p":[$n[11].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOPlayBackwards","is":true,"t":8,"pi":[{"n":"target","pt":$n[11].AudioMixer,"ps":0}],"sn":"DOPlayBackwards","rt":$n[0].Int32,"p":[$n[11].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOPlayForward","is":true,"t":8,"pi":[{"n":"target","pt":$n[11].AudioMixer,"ps":0}],"sn":"DOPlayForward","rt":$n[0].Int32,"p":[$n[11].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DORestart","is":true,"t":8,"pi":[{"n":"target","pt":$n[11].AudioMixer,"ps":0}],"sn":"DORestart","rt":$n[0].Int32,"p":[$n[11].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DORewind","is":true,"t":8,"pi":[{"n":"target","pt":$n[11].AudioMixer,"ps":0}],"sn":"DORewind","rt":$n[0].Int32,"p":[$n[11].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOSetFloat","is":true,"t":8,"pi":[{"n":"target","pt":$n[11].AudioMixer,"ps":0},{"n":"floatName","pt":$n[0].String,"ps":1},{"n":"endValue","pt":$n[0].Single,"ps":2},{"n":"duration","pt":$n[0].Single,"ps":3}],"sn":"DOSetFloat","rt":$n[12].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[11].AudioMixer,$n[0].String,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOSmoothRewind","is":true,"t":8,"pi":[{"n":"target","pt":$n[11].AudioMixer,"ps":0}],"sn":"DOSmoothRewind","rt":$n[0].Int32,"p":[$n[11].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"DOTogglePause","is":true,"t":8,"pi":[{"n":"target","pt":$n[11].AudioMixer,"ps":0}],"sn":"DOTogglePause","rt":$n[0].Int32,"p":[$n[11].AudioMixer],"box":function ($v) { return Bridge.box($v, System.Int32);}}]}; }, $n);
    /*DG.Tweening.DOTweenModuleAudio end.*/

    /*DG.Tweening.DOTweenModulePhysics start.*/
    $m("DG.Tweening.DOTweenModulePhysics", function () { return {"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOJump","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody,"ps":0},{"n":"endValue","pt":$n[2].Vector3,"ps":1},{"n":"jumpPower","pt":$n[0].Single,"ps":2},{"n":"numJumps","pt":$n[0].Int32,"ps":3},{"n":"duration","pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOJump","rt":$n[7].Sequence,"p":[$n[2].Rigidbody,$n[2].Vector3,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean]},{"a":4,"n":"DOLocalPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody,"ps":0},{"n":"path","pt":$n[13].Path,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":3}],"sn":"DOLocalPath$1","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[2].Rigidbody,$n[13].Path,$n[0].Single,$n[7].PathMode]},{"a":2,"n":"DOLocalPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody,"ps":0},{"n":"path","pt":System.Array.type(UnityEngine.Vector3),"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathType","dv":0,"o":true,"pt":$n[7].PathType,"ps":3},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":4},{"n":"resolution","dv":10,"o":true,"pt":$n[0].Int32,"ps":5},{"n":"gizmoColor","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Color),"ps":6}],"sn":"DOLocalPath","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[2].Rigidbody,System.Array.type(UnityEngine.Vector3),$n[0].Single,$n[7].PathType,$n[7].PathMode,$n[0].Int32,$n[0].Nullable$1(UnityEngine.Color)]},{"a":2,"n":"DOLookAt","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody,"ps":0},{"n":"towards","pt":$n[2].Vector3,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"axisConstraint","dv":0,"o":true,"pt":$n[7].AxisConstraint,"ps":3},{"n":"up","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Vector3),"ps":4}],"sn":"DOLookAt","rt":$n[12].TweenerCore$3(UnityEngine.Quaternion,UnityEngine.Vector3,DG.Tweening.Plugins.Options.QuaternionOptions),"p":[$n[2].Rigidbody,$n[2].Vector3,$n[0].Single,$n[7].AxisConstraint,$n[0].Nullable$1(UnityEngine.Vector3)]},{"a":2,"n":"DOMove","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody,"ps":0},{"n":"endValue","pt":$n[2].Vector3,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMove","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].Rigidbody,$n[2].Vector3,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveX","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveX","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].Rigidbody,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveY","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveY","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].Rigidbody,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveZ","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveZ","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].Rigidbody,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":4,"n":"DOPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody,"ps":0},{"n":"path","pt":$n[13].Path,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":3}],"sn":"DOPath$1","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[2].Rigidbody,$n[13].Path,$n[0].Single,$n[7].PathMode]},{"a":2,"n":"DOPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody,"ps":0},{"n":"path","pt":System.Array.type(UnityEngine.Vector3),"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathType","dv":0,"o":true,"pt":$n[7].PathType,"ps":3},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":4},{"n":"resolution","dv":10,"o":true,"pt":$n[0].Int32,"ps":5},{"n":"gizmoColor","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Color),"ps":6}],"sn":"DOPath","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[2].Rigidbody,System.Array.type(UnityEngine.Vector3),$n[0].Single,$n[7].PathType,$n[7].PathMode,$n[0].Int32,$n[0].Nullable$1(UnityEngine.Color)]},{"a":2,"n":"DORotate","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody,"ps":0},{"n":"endValue","pt":$n[2].Vector3,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"mode","dv":0,"o":true,"pt":$n[7].RotateMode,"ps":3}],"sn":"DORotate","rt":$n[12].TweenerCore$3(UnityEngine.Quaternion,UnityEngine.Vector3,DG.Tweening.Plugins.Options.QuaternionOptions),"p":[$n[2].Rigidbody,$n[2].Vector3,$n[0].Single,$n[7].RotateMode]}]}; }, $n);
    /*DG.Tweening.DOTweenModulePhysics end.*/

    /*DG.Tweening.DOTweenModulePhysics2D start.*/
    $m("DG.Tweening.DOTweenModulePhysics2D", function () { return {"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOJump","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"jumpPower","pt":$n[0].Single,"ps":2},{"n":"numJumps","pt":$n[0].Int32,"ps":3},{"n":"duration","pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOJump","rt":$n[7].Sequence,"p":[$n[2].Rigidbody2D,$n[2].Vector2,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean]},{"a":4,"n":"DOLocalPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody2D,"ps":0},{"n":"path","pt":$n[13].Path,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":3}],"sn":"DOLocalPath$1","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[2].Rigidbody2D,$n[13].Path,$n[0].Single,$n[7].PathMode]},{"a":2,"n":"DOLocalPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody2D,"ps":0},{"n":"path","pt":System.Array.type(UnityEngine.Vector2),"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathType","dv":0,"o":true,"pt":$n[7].PathType,"ps":3},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":4},{"n":"resolution","dv":10,"o":true,"pt":$n[0].Int32,"ps":5},{"n":"gizmoColor","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Color),"ps":6}],"sn":"DOLocalPath","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[2].Rigidbody2D,System.Array.type(UnityEngine.Vector2),$n[0].Single,$n[7].PathType,$n[7].PathMode,$n[0].Int32,$n[0].Nullable$1(UnityEngine.Color)]},{"a":2,"n":"DOMove","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMove","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].Rigidbody2D,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveX","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveX","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].Rigidbody2D,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveY","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveY","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].Rigidbody2D,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":4,"n":"DOPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody2D,"ps":0},{"n":"path","pt":$n[13].Path,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":3}],"sn":"DOPath$1","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[2].Rigidbody2D,$n[13].Path,$n[0].Single,$n[7].PathMode]},{"a":2,"n":"DOPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody2D,"ps":0},{"n":"path","pt":System.Array.type(UnityEngine.Vector2),"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathType","dv":0,"o":true,"pt":$n[7].PathType,"ps":3},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":4},{"n":"resolution","dv":10,"o":true,"pt":$n[0].Int32,"ps":5},{"n":"gizmoColor","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Color),"ps":6}],"sn":"DOPath","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[2].Rigidbody2D,System.Array.type(UnityEngine.Vector2),$n[0].Single,$n[7].PathType,$n[7].PathMode,$n[0].Int32,$n[0].Nullable$1(UnityEngine.Color)]},{"a":2,"n":"DORotate","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DORotate","rt":$n[12].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[2].Rigidbody2D,$n[0].Single,$n[0].Single]}]}; }, $n);
    /*DG.Tweening.DOTweenModulePhysics2D end.*/

    /*DG.Tweening.DOTweenModuleSprite start.*/
    $m("DG.Tweening.DOTweenModuleSprite", function () { return {"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOBlendableColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].SpriteRenderer,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOBlendableColor","rt":$n[7].Tweener,"p":[$n[2].SpriteRenderer,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].SpriteRenderer,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor","rt":$n[12].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[2].SpriteRenderer,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].SpriteRenderer,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade","rt":$n[12].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[2].SpriteRenderer,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOGradientColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].SpriteRenderer,"ps":0},{"n":"gradient","pt":pc.ColorGradient,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOGradientColor","rt":$n[7].Sequence,"p":[$n[2].SpriteRenderer,pc.ColorGradient,$n[0].Single]}]}; }, $n);
    /*DG.Tweening.DOTweenModuleSprite end.*/

    /*DG.Tweening.DOTweenModuleUI start.*/
    $m("DG.Tweening.DOTweenModuleUI", function () { return {"nested":[$n[7].DOTweenModuleUI.Utils],"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOAnchorMax","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorMax","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorMin","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorMin","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3D","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[2].Vector3,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3D","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[2].Vector3,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3DX","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3DX","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3DY","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3DY","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3DZ","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3DZ","rt":$n[12].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPosX","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPosX","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPosY","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPosY","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOBlendableColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Graphic,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOBlendableColor","rt":$n[7].Tweener,"p":[$n[4].Graphic,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOBlendableColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Image,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOBlendableColor$1","rt":$n[7].Tweener,"p":[$n[4].Image,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOBlendableColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Text,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOBlendableColor$2","rt":$n[7].Tweener,"p":[$n[4].Text,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Graphic,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor","rt":$n[12].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Graphic,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Image,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor$1","rt":$n[12].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Image,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Outline,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor$2","rt":$n[12].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Outline,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Text,"ps":0},{"n":"endValue","pt":$n[2].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor$3","rt":$n[12].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Text,$n[2].Color,$n[0].Single]},{"a":2,"n":"DOCounter","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Text,"ps":0},{"n":"fromValue","pt":$n[0].Int32,"ps":1},{"n":"endValue","pt":$n[0].Int32,"ps":2},{"n":"duration","pt":$n[0].Single,"ps":3},{"n":"addThousandsSeparator","dv":true,"o":true,"pt":$n[0].Boolean,"ps":4},{"n":"culture","dv":null,"o":true,"pt":$n[14].CultureInfo,"ps":5}],"sn":"DOCounter","rt":$n[12].TweenerCore$3(System.Int32,System.Int32,DG.Tweening.Plugins.Options.NoOptions),"p":[$n[4].Text,$n[0].Int32,$n[0].Int32,$n[0].Single,$n[0].Boolean,$n[14].CultureInfo]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].CanvasGroup,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade","rt":$n[12].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[2].CanvasGroup,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Graphic,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$1","rt":$n[12].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Graphic,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Image,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$2","rt":$n[12].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Image,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Outline,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$3","rt":$n[12].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Outline,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Text,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$4","rt":$n[12].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Text,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFillAmount","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Image,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFillAmount","rt":$n[12].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[4].Image,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFlexibleSize","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].LayoutElement,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOFlexibleSize","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[4].LayoutElement,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOGradientColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Image,"ps":0},{"n":"gradient","pt":pc.ColorGradient,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOGradientColor","rt":$n[7].Sequence,"p":[$n[4].Image,pc.ColorGradient,$n[0].Single]},{"a":2,"n":"DOHorizontalNormalizedPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].ScrollRect,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOHorizontalNormalizedPos","rt":$n[7].Tweener,"p":[$n[4].ScrollRect,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOJumpAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"jumpPower","pt":$n[0].Single,"ps":2},{"n":"numJumps","pt":$n[0].Int32,"ps":3},{"n":"duration","pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOJumpAnchorPos","rt":$n[7].Sequence,"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMinSize","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].LayoutElement,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMinSize","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[4].LayoutElement,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DONormalizedPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].ScrollRect,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DONormalizedPos","rt":$n[7].Tweener,"p":[$n[4].ScrollRect,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOPivot","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOPivot","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single]},{"a":2,"n":"DOPivotX","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOPivotX","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOPivotY","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOPivotY","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOPreferredSize","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].LayoutElement,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOPreferredSize","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[4].LayoutElement,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOPunchAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"punch","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"vibrato","dv":10,"o":true,"pt":$n[0].Int32,"ps":3},{"n":"elasticity","dv":1.0,"o":true,"pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOPunchAnchorPos","rt":$n[7].Tweener,"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOScale","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Outline,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOScale","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[4].Outline,$n[2].Vector2,$n[0].Single]},{"a":2,"n":"DOShakeAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"duration","pt":$n[0].Single,"ps":1},{"n":"strength","dv":100.0,"o":true,"pt":$n[0].Single,"ps":2},{"n":"vibrato","dv":10,"o":true,"pt":$n[0].Int32,"ps":3},{"n":"randomness","dv":90.0,"o":true,"pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5},{"n":"fadeOut","dv":true,"o":true,"pt":$n[0].Boolean,"ps":6},{"n":"randomnessMode","dv":0,"o":true,"pt":$n[7].ShakeRandomnessMode,"ps":7}],"sn":"DOShakeAnchorPos","rt":$n[7].Tweener,"p":[$n[2].RectTransform,$n[0].Single,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean,$n[0].Boolean,$n[7].ShakeRandomnessMode]},{"a":2,"n":"DOShakeAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"duration","pt":$n[0].Single,"ps":1},{"n":"strength","pt":$n[2].Vector2,"ps":2},{"n":"vibrato","dv":10,"o":true,"pt":$n[0].Int32,"ps":3},{"n":"randomness","dv":90.0,"o":true,"pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5},{"n":"fadeOut","dv":true,"o":true,"pt":$n[0].Boolean,"ps":6},{"n":"randomnessMode","dv":0,"o":true,"pt":$n[7].ShakeRandomnessMode,"ps":7}],"sn":"DOShakeAnchorPos$1","rt":$n[7].Tweener,"p":[$n[2].RectTransform,$n[0].Single,$n[2].Vector2,$n[0].Int32,$n[0].Single,$n[0].Boolean,$n[0].Boolean,$n[7].ShakeRandomnessMode]},{"a":2,"n":"DOShapeCircle","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"center","pt":$n[2].Vector2,"ps":1},{"n":"endValueDegrees","pt":$n[0].Single,"ps":2},{"n":"duration","pt":$n[0].Single,"ps":3},{"n":"relativeCenter","dv":false,"o":true,"pt":$n[0].Boolean,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOShapeCircle","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.CircleOptions),"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single,$n[0].Single,$n[0].Boolean,$n[0].Boolean]},{"a":2,"n":"DOSizeDelta","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].RectTransform,"ps":0},{"n":"endValue","pt":$n[2].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOSizeDelta","rt":$n[12].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[2].RectTransform,$n[2].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOText","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Text,"ps":0},{"n":"endValue","pt":$n[0].String,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"richTextEnabled","dv":true,"o":true,"pt":$n[0].Boolean,"ps":3},{"n":"scrambleMode","dv":0,"o":true,"pt":$n[7].ScrambleMode,"ps":4},{"n":"scrambleChars","dv":null,"o":true,"pt":$n[0].String,"ps":5}],"sn":"DOText","rt":$n[12].TweenerCore$3(System.String,System.String,DG.Tweening.Plugins.Options.StringOptions),"p":[$n[4].Text,$n[0].String,$n[0].Single,$n[0].Boolean,$n[7].ScrambleMode,$n[0].String]},{"a":2,"n":"DOValue","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Slider,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOValue","rt":$n[12].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[4].Slider,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOVerticalNormalizedPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].ScrollRect,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOVerticalNormalizedPos","rt":$n[7].Tweener,"p":[$n[4].ScrollRect,$n[0].Single,$n[0].Single,$n[0].Boolean]}]}; }, $n);
    /*DG.Tweening.DOTweenModuleUI end.*/
