...
if ( TRACE ) { TRACE( "Howitzer.Projectile#OnTriggerEnter", this ); }
                ...
                if (UnityEngine.MonoBehaviour.op_Inequality(this._targetTank, null)) {
                    var hitTankAI = { };
                    if (other.gameObject.TryGetComponent$1(BehaviourAI.TankAI, hitTankAI)) {
                        this.DestroyTank(hitTankAI.v);
                        this.gameObject.SetActive(false);
                    }
                } else {
                    var hitTankAI1 = { };
                    if (other.gameObject.TryGetComponent$1(BehaviourAI.TankAI, hitTankAI1)) {
