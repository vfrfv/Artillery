...
if ( TRACE ) { TRACE( "Pumping#SetNormalPositionArte", this ); }
    ...
    Bridge.define("Shoot2", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "Shoot2#init", this ); }
        ...
        methods: {
            /*Shoot2.Awake start.*/
            Awake: function () {
if ( TRACE ) { TRACE( "Shoot2#Awake", this ); }
            ...
            /*Shoot2.OnEnable start.*/
            OnEnable: function () {
if ( TRACE ) { TRACE( "Shoot2#OnEnable", this ); }
            ...
            /*Shoot2.OnDisable start.*/
            OnDisable: function () {
if ( TRACE ) { TRACE( "Shoot2#OnDisable", this ); }

                UI.PlayerUIController.removeOnShoot(Bridge.fn.cacheBind(this, this.ChooseShootingRange));
                Howitzer.PlayerZoom.removeOnZoomChanged(Bridge.fn.cacheBind(this, this.SetZoomState));
            },
            /*Shoot2.OnDisable end.*/

            /*Shoot2.Upgrade start.*/
            Upgrade: function () {
if ( TRACE ) { TRACE( "Shoot2#Upgrade", this ); }

                this._newArt = true;
            },
            /*Shoot2.Upgrade end.*/

            /*Shoot2.SetZoomState start.*/
            SetZoomState: function (isZoomed) {
if ( TRACE ) { TRACE( "Shoot2#SetZoomState", this ); }

                this._isZoomed = isZoomed;
            },
            /*Shoot2.SetZoomState end.*/

            /*Shoot2.ChooseShootingRange start.*/
            ChooseShootingRange: function () {
if ( TRACE ) { TRACE( "Shoot2#ChooseShootingRange", this ); }
            ...
            /*Shoot2.ChooseShootingRange end.*/

            /*Shoot2.Shoot1 start.*/
            Shoot1: function () {
if ( TRACE ) { TRACE( "Shoot2#Shoot1", this ); }
                ...
                // ���������, �������� �� � ����
                if (!this._firstShot && UnityEngine.Physics.Raycast$1(ray, hit)) {
                    if (hit.v.collider.CompareTag("Tank")) {
            ...
            /*Shoot2.Shoot22 start.*/
            Shoot22: function () {
if ( TRACE ) { TRACE( "Shoot2#Shoot22", this ); }
            ...
            /*Shoot2.ShakeCamera start.*/
            ShakeCamera: function () {
if ( TRACE ) { TRACE( "Shoot2#ShakeCamera", this ); }
