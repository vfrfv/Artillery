...
if ( TRACE ) { TRACE( "CFX_SpawnSystem#Start", this ); }
    ...
    Bridge.define("Cross", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "Cross#init", this ); }
...
if ( TRACE ) { TRACE( "Cross#OnEnable", this ); }
                ...
                if (this._isUpgraded === false) {
                    this.StartCoroutine$1(this.ScaleAndDisable());
                }
            },
            /*Cross.OnEnable end.*/

            /*Cross.Upgraded start.*/
            Upgraded: function () {
if ( TRACE ) { TRACE( "Cross#Upgraded", this ); }
            ...
            /*Cross.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "Cross#Update", this ); }

                UnityEngine.Debug.Log$1("\ufffd\ufffd\ufffd\ufffd\ufffd\ufffd\ufffd" + System.Boolean.toString(this._isUpgraded));
            },
            /*Cross.Update end.*/
...
if ( TRACE ) { TRACE( "FollowBullet#ReturnStartPosition", this ); }
                ...
                this._aim.gameObject.SetActive(true);
            },
...
if ( TRACE ) { TRACE( "Howitzer.LookAtReticle#init", this ); }
                ...
                this.maxYawAngle = 60.0;
                this.minYawAngle = -60.0;
...
if ( TRACE ) { TRACE( "Howitzer.LookAtReticle#RotateTowardsReticle", this ); }
                ...
                targetYaw = Math.max(this.minYawAngle, Math.min(targetYaw, this.maxYawAngle));
...
if ( TRACE ) { TRACE( "Howitzer.PlayerShooting#ChooseShootingRange", this ); }
                ...
                if (this._newArt === false) {
                    ...
                    this.StartCoroutine$1(this.Shoot2());
                }
            },
...
if ( TRACE ) { TRACE( "Howitzer.PlayerShooting#Shoot1", this ); }
                ...
                projectileComponent.Initialize(this.projectileSpeed, this.explosionEffect, this._playerUIController, tankAIList, this._pumping, null, this._playerZoom);
                            ...
                            switch ($step) {
                                ...
                                case 2: {
                                    projectile = this._projectilePool.GetObject();
                                        ...
                                        targetPosition = tankAIList.getItem(i).transform.position.$clone().add( pc.Vec3.UP.clone().clone().scale( 2.0 ) );
                                        ...
                                        projectileComponent.Initialize(this.projectileSpeed, this.explosionEffect, this._playerUIController, tankAIList, this._pumping, tankAIList.getItem(i), this._playerZoom);
                                ...
                                case 5: {
                                    if (UnityEngine.GameObject.op_Inequality(lastProjectile, null)) {
                                            ...
                                            if (UnityEngine.MonoBehaviour.op_Inequality(projectileComponent1, null)) {
                                                ...
                                                this._managerCamers.GetBullet(projectileComponent1, true);
                                                this._managerCamers.WatchingBullet();
                                            }
                                        }
...
if ( TRACE ) { TRACE( "Howitzer.PlayerZoom#ToggleZoom", this ); }
                ...
                var $t, $t1, $t2;
                if (!this._isZoomed && this._isStore) {
                    this.OpenStore();
...
if ( TRACE ) { TRACE( "Howitzer.PlayerZoom#RotateCameraWithJoystick", this ); }
                ...
                var targetRotationX = Math.max(6.0, Math.min(currentX - joystickY * xSensitivity, 20.0));
                var targetRotationY = Math.max(-90.0, Math.min(currentY + joystickX * ySensitivity, -45.0));
    ...
    Bridge.define("Howitzer.Projectile", {
        ...
        methods: {
            ...
            Initialize: function (speed, explosionParticle, playerUIController, tanks, pumping, targetTank, playerZoom) {
if ( TRACE ) { TRACE( "Howitzer.Projectile#Initialize", this ); }
            ...
            /*Howitzer.Projectile.OnTriggerEnter start.*/
            OnTriggerEnter: function (other) {
if ( TRACE ) { TRACE( "Howitzer.Projectile#OnTriggerEnter", this ); }

                var $t;
                var hitTankAI = { };
                if (other.TryGetComponent$1(BehaviourAI.TankAI, hitTankAI)) {
                    ...
                    this.StartCoroutine$1(this.DisableAfterDelay());
            ...
            /*Howitzer.Projectile.OnTriggerEnter end.*/

            /*Howitzer.Projectile.DisableAfterDelay start.*/
            DisableAfterDelay: function () {
if ( TRACE ) { TRACE( "Howitzer.Projectile#DisableAfterDelay", this ); }
            ...
            /*Howitzer.Projectile.DisableAfterDelay end.*/
...
if ( TRACE ) { TRACE( "Pumping#TurnPlayerCamera", this ); }
                ...
                this._shopping.gameObject.SetActive(false);
                this._arm2.gameObject.SetActive(false);
...
if ( TRACE ) { TRACE( "Shopping#OffShoping", this ); }
                ...
                this._playerUIController.Upgraded();
                this._cross.Upgraded();
                this._cross2.Upgraded();
            },
            /*Shopping.OffShoping end.*/

            /*Shopping.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "Shopping#Update", this ); }
...
if ( TRACE ) { TRACE( "UI.EndCardAnimation#ResizeText", this ); }
    ...
    Bridge.define("UI.PlayerUIController", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "UI.PlayerUIController#init", this ); }
...
if ( TRACE ) { TRACE( "UI.PlayerUIController#Start", this ); }
            ...
            /*UI.PlayerUIController.Upgraded start.*/
            Upgraded: function () {
if ( TRACE ) { TRACE( "UI.PlayerUIController#Upgraded", this ); }

                this._isUpgraded = true;
            },
            /*UI.PlayerUIController.Upgraded end.*/
...
if ( TRACE ) { TRACE( "UI.PlayerUIController#ShowCross", this ); }
            ...
            /*UI.PlayerUIController.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "UI.PlayerUIController#Update", this ); }

                UnityEngine.Debug.Log$1("\u041a\u0440\u0435\u0441\u0442\u0438\u043a" + System.Boolean.toString(this._isUpgraded));
            },
            /*UI.PlayerUIController.Update end.*/
...
if ( TRACE ) { TRACE( "VariableJoystick#HandleInput", this ); }
    ...
    var $m = Bridge.setMetadata,
        $n = ["System.Collections","System","UnityEngine","System.Collections.Generic","UnityEngine.UI","UnityEngine.EventSystems","Howitzer","Fabric","UI","DG.Tweening","BehaviourAI","Bootstraps","UnityEngine.Audio","DG.Tweening.Core","DG.Tweening.Plugins.Core.PathCore","System.Globalization","DG.Tweening.Plugins.Options"];
    ...
    /*Shopping start.*/
    $m("Shopping", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"OffShoping","t":8,"sn":"OffShoping","rt":$n[1].Void},{"a":1,"n":"OnDisable","t":8,"sn":"OnDisable","rt":$n[1].Void},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[1].Void},{"a":1,"n":"ShowInventory","t":8,"sn":"ShowInventory","rt":$n[1].Void},{"a":2,"n":"ShowShopping","t":8,"sn":"ShowShopping","rt":$n[1].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[1].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_cross","t":4,"rt":Cross,"sn":"_cross"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_cross2","t":4,"rt":Cross,"sn":"_cross2"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_improveButton","t":4,"rt":$n[4].Button,"sn":"_improveButton"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_indicatorr","t":4,"rt":Indicatorr,"sn":"_indicatorr"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_interactiveArt","t":4,"rt":InteractiveArt,"sn":"_interactiveArt"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_playerUIController","t":4,"rt":$n[8].PlayerUIController,"sn":"_playerUIController"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_purchase","t":4,"rt":$n[4].Button,"sn":"_purchase"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_shopping","t":4,"rt":$n[2].GameObject,"sn":"_shopping"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_shoppingPlayer","t":4,"rt":$n[6].PlayerShooting,"sn":"_shoppingPlayer"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_tanksFabric","t":4,"rt":$n[7].TanksFabric,"sn":"_tanksFabric"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_unavailableWeaponButton","t":4,"rt":$n[4].Button,"sn":"_unavailableWeaponButton"}]}; }, $n);
    /*Shopping end.*/

    /*Cross start.*/
    $m("Cross", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[1].Void},{"a":1,"n":"ScaleAndDisable","t":8,"sn":"ScaleAndDisable","rt":$n[0].IEnumerator},{"a":1,"n":"ScaleOverTime","t":8,"pi":[{"n":"targetScale","pt":$n[2].Vector3,"ps":0},{"n":"duration","pt":$n[1].Single,"ps":1}],"sn":"ScaleOverTime","rt":$n[0].IEnumerator,"p":[$n[2].Vector3,$n[1].Single]},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[1].Void},{"a":2,"n":"Upgraded","t":8,"sn":"Upgraded","rt":$n[1].Void},{"a":1,"n":"_isUpgraded","t":4,"rt":$n[1].Boolean,"sn":"_isUpgraded","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}}]}; }, $n);
    /*Cross end.*/
    ...
    /*Howitzer.Projectile start.*/
    $m("Howitzer.Projectile", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"DestroyTank","t":8,"pi":[{"n":"hitTankAI","pt":$n[10].TankAI,"ps":0}],"sn":"DestroyTank","rt":$n[1].Void,"p":[$n[10].TankAI]},{"a":1,"n":"DisableAfterDelay","t":8,"sn":"DisableAfterDelay","rt":$n[0].IEnumerator},{"a":2,"n":"Initialize","t":8,"pi":[{"n":"speed","pt":$n[1].Single,"ps":0},{"n":"explosionParticle","pt":$n[2].GameObject,"ps":1},{"n":"playerUIController","pt":$n[8].PlayerUIController,"ps":2},{"n":"tanks","pt":$n[3].List$1(BehaviourAI.TankAI),"ps":3},{"n":"pumping","pt":Pumping,"ps":4},{"n":"targetTank","pt":$n[10].TankAI,"ps":5},{"n":"playerZoom","pt":$n[6].PlayerZoom,"ps":6}],"sn":"Initialize","rt":$n[1].Void,"p":[$n[1].Single,$n[2].GameObject,$n[8].PlayerUIController,$n[3].List$1(BehaviourAI.TankAI),Pumping,$n[10].TankAI,$n[6].PlayerZoom]},{"a":1,"n":"OnTriggerEnter","t":8,"pi":[{"n":"other","pt":$n[2].Collider,"ps":0}],"sn":"OnTriggerEnter","rt":$n[1].Void,"p":[$n[2].Collider]},{"a":1,"n":"SpawnExplosionEffect","t":8,"pi":[{"n":"position","pt":$n[2].Vector3,"ps":0}],"sn":"SpawnExplosionEffect","rt":$n[1].Void,"p":[$n[2].Vector3]},{"a":1,"n":"_explosionParticle","t":4,"rt":$n[2].GameObject,"sn":"_explosionParticle"},{"a":1,"n":"_playerUIController","t":4,"rt":$n[8].PlayerUIController,"sn":"_playerUIController"},{"a":1,"n":"_playerZoom","t":4,"rt":$n[6].PlayerZoom,"sn":"_playerZoom"},{"a":1,"n":"_pumping","t":4,"rt":Pumping,"sn":"_pumping"},{"a":1,"n":"_rigidbody","t":4,"rt":$n[2].Rigidbody,"sn":"_rigidbody"},{"a":1,"n":"_speed","t":4,"rt":$n[1].Single,"sn":"_speed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"_tanks","t":4,"rt":$n[3].List$1(BehaviourAI.TankAI),"sn":"_tanks"},{"a":1,"n":"_targetTank","t":4,"rt":$n[10].TankAI,"sn":"_targetTank"},{"a":2,"n":"Crashed","t":2,"ad":{"a":2,"n":"add_Crashed","t":8,"pi":[{"n":"value","pt":Function,"ps":0}],"sn":"addCrashed","rt":$n[1].Void,"p":[Function]},"r":{"a":2,"n":"remove_Crashed","t":8,"pi":[{"n":"value","pt":Function,"ps":0}],"sn":"removeCrashed","rt":$n[1].Void,"p":[Function]}}]}; }, $n);
    /*Howitzer.Projectile end.*/
    ...
    /*DG.Tweening.DOTweenModuleUtils start.*/
    $m("DG.Tweening.DOTweenModuleUtils", function () { return {"nested":[$n[9].DOTweenModuleUtils.Physics],"att":1048961,"a":2,"s":true,"m":[{"at":[new UnityEngine.Scripting.PreserveAttribute()],"a":2,"n":"Init","is":true,"t":8,"sn":"Init","rt":$n[1].Void},{"at":[new UnityEngine.Scripting.PreserveAttribute()],"a":1,"n":"Preserver","is":true,"t":8,"sn":"Preserver","rt":$n[1].Void},{"a":1,"n":"_initialized","is":true,"t":4,"rt":$n[1].Boolean,"sn":"_initialized","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}}]}; }, $n);
    /*DG.Tweening.DOTweenModuleUtils end.*/

    /*DG.Tweening.DOTweenModuleUtils+Physics start.*/
    $m("DG.Tweening.DOTweenModuleUtils.Physics", function () { return {"td":$n[9].DOTweenModuleUtils,"att":1048962,"a":2,"s":true,"m":[{"at":[new UnityEngine.Scripting.PreserveAttribute()],"a":2,"n":"CreateDOTweenPathTween","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].MonoBehaviour,"ps":0},{"n":"tweenRigidbody","pt":$n[1].Boolean,"ps":1},{"n":"isLocal","pt":$n[1].Boolean,"ps":2},{"n":"path","pt":$n[14].Path,"ps":3},{"n":"duration","pt":$n[1].Single,"ps":4},{"n":"pathMode","pt":$n[9].PathMode,"ps":5}],"sn":"CreateDOTweenPathTween","rt":$n[13].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[2].MonoBehaviour,$n[1].Boolean,$n[1].Boolean,$n[14].Path,$n[1].Single,$n[9].PathMode]},{"at":[new UnityEngine.Scripting.PreserveAttribute()],"a":2,"n":"HasRigidbody","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Component,"ps":0}],"sn":"HasRigidbody","rt":$n[1].Boolean,"p":[$n[2].Component],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"HasRigidbody2D","is":true,"t":8,"pi":[{"n":"target","pt":$n[2].Component,"ps":0}],"sn":"HasRigidbody2D","rt":$n[1].Boolean,"p":[$n[2].Component],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"SetOrientationOnPath","is":true,"t":8,"pi":[{"n":"options","pt":$n[16].PathOptions,"ps":0},{"n":"t","pt":$n[9].Tween,"ps":1},{"n":"newRot","pt":$n[2].Quaternion,"ps":2},{"n":"trans","pt":$n[2].Transform,"ps":3}],"sn":"SetOrientationOnPath","rt":$n[1].Void,"p":[$n[16].PathOptions,$n[9].Tween,$n[2].Quaternion,$n[2].Transform]}]}; }, $n);
    /*DG.Tweening.DOTweenModuleUtils+Physics end.*/
